  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-gold": "linear-gradient(135deg, hsl(43, 96%, 56%) 0%, hsl(28, 100%, 50%) 100%)",
        "gradient-blue": "linear-gradient(135deg, hsl(217, 91%, 60%) 0%, hsl(250, 91%, 70%) 100%)",
      ...
      boxShadow: {
        'neon': '0 0 20px -5px hsl(var(--primary) / 0.3)',
